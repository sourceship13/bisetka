// ARViroOverlay.tsx — DISABLED on 2026-05-21
//
// Viro (@viro-community/react-viro) was removed from the project because the
// games use the WebView+Three.js based AR3DOverlay.tsx instead and Viros
// prebuilt static lib was blocking iOS-simulator builds on Apple Silicon.
//
// Original implementation is preserved below (line-commented) and in git
// history (and src/components/ARViroOverlay.tsx.bak).
//
export {};
